...
|---|---|---:|---:|
| Management authorization, cross-tenant denial, secret containment, audit, integration, concurrent state isolation, webhook idempotency/outbound eligibility, invitations, billing, router, cloud policy, and route contracts | `node --test tests/management-*.test.mjs tests/api-webhooks.test.mjs` | 19 passed, 0 failed | 332ms |
