---
name: speckit-spex-using-superpowers
description: 'Spex methodology entry point: workflow routing, process discipline,
  spec-first principle, and skill discovery'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex:commands/speckit.spex.using-superpowers.md
---
