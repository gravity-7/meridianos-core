...
description: Refine rough ideas into executable specifications through collaborative
  questioning, alternative exploration, and incremental validation. Use --sync to
  archive completed brainstorm documents.
...
After the brainstorm document is written and overview updated, present the choice as a clear text prompt:
...
Present the sync summary to the user using present the choice as a clear text prompt:
