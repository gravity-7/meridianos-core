...
description: 'Guided Demo: synthesize user-observable flows from spec FRs, triage
  infrastructure, present evidence humans can evaluate'
...
Present options using present the choice as a clear text prompt:
...
present the choice as a clear text prompt:
...
5. **Ask for verdict**: present the choice as a clear text prompt with your recommendation as the first option:
